...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('RL Q-learning. Akhiril Anwar Harahap')
    ...
    def build_environment(self):
        ...
        self.bg = self.canvas_widget.create_image(
            0, 0, anchor='nw', image=self.background)
        ...
        self.obstacle1 = self.canvas_widget.create_image(
            pixels * 1, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 2
        ...
        self.obstacle3 = self.canvas_widget.create_image(
            pixels * 4, pixels * 1, anchor='nw', image=self.obstacle5_object)
        # Obstacle 4
        ...
        self.obstacle6 = self.canvas_widget.create_image(
            pixels * 4, pixels * 2, anchor='nw', image=self.obstacle7_object)
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(
            pixels * 7, pixels * 6, anchor='nw', image=self.obstacle9_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(
            pixels * 4, pixels * 3, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(
            pixels * 9, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(
            pixels * 9, pixels * 9, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(
            pixels * 8, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(
            pixels * 9, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(
            pixels * 6, pixels * 3, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(
            pixels * 7, pixels * 5, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(
            pixels * 2, pixels * 4, anchor='nw', image=self.obstacle1_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(
            pixels * 5, pixels * 3, anchor='nw', image=self.obstacle3_object)
        # Obstacle 17
        ...
        self.obstacle18 = self.canvas_widget.create_image(
            pixels * 7, pixels * 3, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(
            pixels * 7, pixels * 4, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(
            pixels * 7, pixels * 9, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(
            pixels * 8, pixels * 9, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(
            pixels * 2, pixels * 2, anchor='nw', image=self.obstacle2_object)

        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(
            pixels * 8, pixels * 8, anchor='nw', image=self.flag_object)
